    ...
    <nav className="sticky top-0 z-50 border-b border-[#D4CFC7] bg-[#FFFFFF]/90 backdrop-blur-md transition-colors duration-300 dark:border-[#3A3A38] dark:bg-[#242422]/90">
      <div className="mx-auto max-w-4xl px-6">
        <div className="flex h-16 items-center justify-between">
          <a
            href={logoLink ?? '/#about'}
            className="hover:text-teal-hover text-lg font-bold tracking-tight text-[#2C3E3E] transition-colors duration-200 hover:text-[#4A8B8B] hover:underline dark:text-[#E8E4DC] dark:hover:text-[#5CA8A8]"
          >
            {logoText}
          </a>
